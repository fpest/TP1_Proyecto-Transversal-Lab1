...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-10-2021 a las 14:02:08
...
ALTER TABLE `inscripcion`
  ...
  ADD UNIQUE KEY `unificar` (`idAlumno`,`idMateria`),
...
--
ALTER TABLE `inscripcion`
  MODIFY `idInscripcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
